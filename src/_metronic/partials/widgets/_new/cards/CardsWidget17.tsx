      ...
      <div className='card-header pt-5'>
        <div className='card-title d-flex flex-column'>
          <div className='d-flex align-items-center'>
            ...
            <span className='fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2'>169,700</span>

            <span className='badge badge-light-success fs-base'>
              <KTIcon iconName='arrow-up' className='fs-5 text-success ms-n1' /> 2.2%
            </span>
          </div>
          <span className='text-gray-500 pt-1 fw-semibold fs-6'>Products Earnings in April</span>
        </div>
      </div>
      ...
      <div className='card-body pt-2 pb-4 d-flex flex-wrap align-items-center'>
        ...
        <div className='d-flex flex-column content-justify-center flex-row-fluid'>
          <div className='d-flex fw-semibold align-items-center'>
            ...
            <div className='fw-bolder text-gray-700 text-xxl-end'>₹17,660</div>
          </div>
          <div className='d-flex fw-semibold align-items-center my-3'>
            <div className='bullet w-8px h-3px rounded-2 bg-primary me-3'></div>
            <div className='text-gray-500 flex-grow-1 me-4'>Products</div>
            <div className='fw-bolder text-gray-700 text-xxl-end'>₹7,820</div>
          </div>
          <div className='d-flex fw-semibold align-items-center'>
            <div
            ...
            <div className=' fw-bolder text-gray-700 text-xxl-end'>₹845,257</div>
          </div>
        </div>
      </div>
    </div>
